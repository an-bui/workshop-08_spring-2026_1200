...
drought_exp_clean <- drought_exp |> 
  ...
  # reordering species name levels
  mutate(species_name = as_factor(species_name),
         species_name = fct_relevel(species_name,
                                    ...
                                    "Grindelia camporum")) |> 
  # reordering water_treatment levels
...
ggplot(data = drought_exp_clean,
  ...
  labs(title = "As SLA increases, total plant mass increases",
...
ggplot(data = drought_exp_clean,
       # x-axis: treatment
       # y-axis: total plant mass
       # color geometries by water treatment
       mapping = aes(x = water_treatment,
                     y = total_g,
                     color = water_treatment)) +
  # representing individuals in each treatment
  ...
  # relabelling axes, adding title
  labs(title = "Well watered individuals tend to have higher mass than drought stressed",
       x = "Treatment",
       y = "Total plant mass (g)") +
  # taking out legend
...
ggplot(data = drought_exp_clean,
       # x-axis: species
       # y-axis: plant mass
       # coloring geometries by species
       mapping = aes(x = species_name,
                     y = total_g,
                     color = species_name)) +
  # jitter to represent individuals in each species
  geom_jitter(height = 0,
              width = 0.1) +
...
- `species_nameEschscholzia californica`: difference between Eschscholzia californica mass in the well watered treatemnt and Lotus scoparius mass in the well watered treatment
...
preds <- ggpredict(
  ...
  # renaming columns to fit original data frame
...
ggplot(data = drought_exp_clean,
  ...
  geom_jitter(height = 0,
              ...
              alpha = 0.4,
              shape = 21) +
  # pointrange: model predictions with 95% CI
